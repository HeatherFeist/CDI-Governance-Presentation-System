  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl font-semibold text-neutral-800">Google Workspace Templates</h2>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5">
        <p className="text-sm font-semibold text-blue-800 mb-2">How to use these templates</p>
        <ol className="text-sm text-blue-700 space-y-1 list-decimal list-inside">
          ...
          <li>Paste it (<kbd className="bg-blue-100 px-1 rounded text-xs">Ctrl+V</kbd>) into your new file and customize</li>
        ...
        {filtered.map((template, i) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white border border-neutral-200 rounded-2xl p-5 hover:shadow-md transition-shadow space-y-4"
            >
              {/* Card header */}
              ...
              <pre className="text-xs text-neutral-400 bg-neutral-50 rounded-xl p-3 overflow-hidden max-h-24 whitespace-pre-wrap font-mono leading-relaxed">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-neutral-900 text-white text-xs font-medium hover:bg-neutral-700 transition-colors"
                >
